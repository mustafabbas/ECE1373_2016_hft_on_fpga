...
set Interfaces {
    ...
    aclk {
        type "clock"
        buses "m_axis_open_port m_axis_tx_data m_axis_tx_length m_axis_tx_metadata s_axis_open_port_status s_axis_rx_data s_axis_rx_metadata"
    }
    aresetn {
        type "reset"
    }
