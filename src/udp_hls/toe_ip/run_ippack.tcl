...
set Revision    "1611281613"
set Description "TCP Offload Engine supporting 10Gbps line rate, up to 10K concurrent sessions & Out-Of-Order segments."
set Device      "kintexu"
...
set Interfaces {
    ...
    m_axis_rxwrite_cmd {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_rxwrite_cmd"
        has_tready "1"
        ports {
            TDATA 72
        }
    ...
    s_axis_rxwrite_sts {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rxwrite_sts"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    aclk {
        type "clock"
        buses "m_axis_listen_port_rsp m_axis_notification m_axis_open_conn_rsp m_axis_rx_data_rsp m_axis_rx_data_rsp_metadata m_axis_rxread_cmd m_axis_rxwrite_cmd m_axis_rxwrite_data m_axis_session_lup_req m_axis_session_upd_req m_axis_tcp_data m_axis_tx_data_rsp m_axis_txread_cmd m_axis_txwrite_cmd m_axis_txwrite_data s_axis_close_conn_req s_axis_listen_port_req s_axis_open_conn_req s_axis_rx_data_req s_axis_rxread_data s_axis_rxwrite_sts s_axis_session_lup_rsp s_axis_session_upd_rsp s_axis_tcp_data s_axis_tx_data_req s_axis_tx_data_req_metadata s_axis_txread_data s_axis_txwrite_sts"
    }
    aresetn {
        type "reset"
    }
