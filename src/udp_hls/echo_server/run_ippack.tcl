...
set Revision    "1611281600"
set Description "Loops back packets from the TOE Rx side to the TOE Tx side."
set Device      "kintexu"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "echo_server_application_top"
...
set Interfaces {
    ...
    aclk {
        type "clock"
        buses "m_axis_close_connection m_axis_listen_port m_axis_open_connection m_axis_read_package m_axis_tx_data m_axis_tx_metadata s_axis_listen_port_status s_axis_notifications s_axis_open_status s_axis_rx_data s_axis_rx_metadata s_axis_tx_status"
    }
    aresetn {
        type "reset"
    }
