...
set Library     "hls"
set IPName      "udpCapitalize"
set Version     "1.10"
set DisplayName "10G UDP Capitalize TestApp module "
set Revision    "1703101428"
set Description "This test app converts incoming strings to uppercase"
set Device      "kintexu"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "udpcapitalize_top"
...
set Interfaces {
    ...
    lbRequestPortOpenOut {
        type "axi4stream"
        mode "master"
        port_prefix "lbRequestPortOpenOut"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    aclk {
        type "clock"
        buses "lbPortOpenReplyIn lbRequestPortOpenOut lbRxDataIn lbRxMetadataIn lbTxDataOut lbTxLengthOut lbTxMetadataOut"
    }
    aresetn {
        type "reset"
    }
