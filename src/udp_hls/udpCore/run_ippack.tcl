...
set IPName      "udp"
set Version     "1.41"
set DisplayName "10G UDP Offload Engine"
set Revision    "1611281746"
set Description "UDP Offload Engine supporting 10Gbps line rate"
set Device      "kintexu"
...
set Interfaces {
    ...
    inputPathOutputMetadata {
        type "axi4stream"
        mode "master"
        port_prefix "inputPathOutputMetadata"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    inputPathPortUnreachable {
        type "axi4stream"
        mode "master"
        port_prefix "inputPathPortUnreachable"
        has_tready "1"
        ports {
            TDATA 64
            TKEEP 8
    ...
    outputPathInMetadata {
        type "axi4stream"
        mode "slave"
        port_prefix "outputPathInMetadata"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    outputpathInLength {
        type "axi4stream"
        mode "slave"
        port_prefix "outputpathInLength"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    aclk {
        type "clock"
        buses "confirmPortStatus inputPathInData inputPathOutputMetadata inputPathPortUnreachable inputpathOutData openPort outputPathInData outputPathInMetadata outputPathOutData outputpathInLength portRelease"
    }
    aresetn {
        type "reset"
    }
